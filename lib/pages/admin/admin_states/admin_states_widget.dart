...
import 'package:provider/provider.dart';
      import 'admin_states_model.dart';
      export 'admin_states_model.dart';
    
class AdminStatesWidget extends StatefulWidget {
  const AdminStatesWidget({super.key }) ;

  

  @override
  State<AdminStatesWidget> createState() => _AdminStatesWidgetState();
}

class _AdminStatesWidgetState extends State<AdminStatesWidget>  {
  late AdminStatesModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminStatesModel());

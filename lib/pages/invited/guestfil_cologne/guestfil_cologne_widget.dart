...
import 'package:provider/provider.dart';
      import 'guestfil_cologne_model.dart';
      export 'guestfil_cologne_model.dart';
    
class GuestfilCologneWidget extends StatefulWidget {
  const GuestfilCologneWidget({super.key , required this.colonia, }) ;

  final DocumentReference? colonia;

  @override
  State<GuestfilCologneWidget> createState() => _GuestfilCologneWidgetState();
}

class _GuestfilCologneWidgetState extends State<GuestfilCologneWidget>  {
  late GuestfilCologneModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuestfilCologneModel());
...
;
                ...
                final guestfilCologneColoniaRecord = snapshot.data!;
...
body: SafeArea(
      ...
      children: [Text(
       ...
       guestfilCologneColoniaRecord.nombreCol  ,
...
SingleChildScrollView(
      ...
      stream: queryPymeRecord(queryBuilder: (pymeRecord) => pymeRecord.where('coloniaPyme', isEqualTo: guestfilCologneColoniaRecord.nombreCol, ),),
      builder: (context, snapshot) {
        // Customize what your widget looks like when it's loading.
        if (!snapshot.hasData) {

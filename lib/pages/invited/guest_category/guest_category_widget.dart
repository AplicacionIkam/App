...
import 'package:provider/provider.dart';
      ...
      export 'guest_category_model.dart';
    
class GuestCategoryWidget extends StatefulWidget {
  const GuestCategoryWidget({super.key }) ;

  

  @override
  State<GuestCategoryWidget> createState() => _GuestCategoryWidgetState();
}

class _GuestCategoryWidgetState extends State<GuestCategoryWidget>  {
  late GuestCategoryModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuestCategoryModel());
...
SingleChildScrollView(
    ...
    context.pushNamed(
      ...
      queryParameters: {'categoria': serializeParam(listViewCategoriaRecord.reference, ParamType.DocumentReference, ),}.withoutNulls,
...
Padding(
       ...
       listViewCategoriaRecord.nombreCate  ,

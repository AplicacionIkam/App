...
import 'package:provider/provider.dart';
      import 'guest_cologne_model.dart';
      export 'guest_cologne_model.dart';
    
class GuestCologneWidget extends StatefulWidget {
  const GuestCologneWidget({super.key , required this.municipio, }) ;

  final DocumentReference? municipio;

  @override
  State<GuestCologneWidget> createState() => _GuestCologneWidgetState();
}

class _GuestCologneWidgetState extends State<GuestCologneWidget>  {
  late GuestCologneModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuestCologneModel());
...
;
                ...
                final guestCologneMunicipioRecord = snapshot.data!;
...
SingleChildScrollView(
      ...
      stream: queryColoniaRecord(queryBuilder: (coloniaRecord) => coloniaRecord.where('refMunicipio', isEqualTo: guestCologneMunicipioRecord.reference, ).orderBy('nombreCol'),),
      builder: (context, snapshot) {
        // Customize what your widget looks like when it's loading.
        if (!snapshot.hasData) {

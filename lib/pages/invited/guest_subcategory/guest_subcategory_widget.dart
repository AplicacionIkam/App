...
import 'package:provider/provider.dart';
      import 'guest_subcategory_model.dart';
      export 'guest_subcategory_model.dart';
    
class GuestSubcategoryWidget extends StatefulWidget {
  const GuestSubcategoryWidget({super.key , required this.categoria, }) ;

  final DocumentReference? categoria;

  @override
  State<GuestSubcategoryWidget> createState() => _GuestSubcategoryWidgetState();
}

class _GuestSubcategoryWidgetState extends State<GuestSubcategoryWidget>  {
  late GuestSubcategoryModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuestSubcategoryModel());
...
;
                ...
                final guestSubcategoryCategoriaRecord = snapshot.data!;
...
SingleChildScrollView(
      ...
      stream: querySubCategoriaRecord(queryBuilder: (subCategoriaRecord) => subCategoriaRecord.where('refCategoria', isEqualTo: guestSubcategoryCategoriaRecord.reference, ).orderBy('nombreSubc'),),
      builder: (context, snapshot) {
        // Customize what your widget looks like when it's loading.
        if (!snapshot.hasData) {

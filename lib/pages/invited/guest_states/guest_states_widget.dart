...
import 'package:provider/provider.dart';
      import 'guest_states_model.dart';
      export 'guest_states_model.dart';
    
class GuestStatesWidget extends StatefulWidget {
  const GuestStatesWidget({super.key }) ;

  

  @override
  State<GuestStatesWidget> createState() => _GuestStatesWidgetState();
}

class _GuestStatesWidgetState extends State<GuestStatesWidget>  {
  late GuestStatesModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuestStatesModel());
...
SingleChildScrollView(
      ...
      builder: (context, snapshot) {
        ...
        List<EstadoRecord> listViewEstadoRecordList = snapshot.data!;
      ...
      itemCount: listViewEstadoRecordList.length,
      
      itemBuilder: (context,  listViewIndex) {
    final listViewEstadoRecord = listViewEstadoRecordList[listViewIndex];
            return Padding(
    ...
    context.pushNamed(
      ...
      queryParameters: {'estado': serializeParam(listViewEstadoRecord.reference, ParamType.DocumentReference, ),}.withoutNulls,
...
Text(
       ...
       listViewEstadoRecord.nombreEst  ,

...
import 'package:provider/provider.dart';
      import 'guestfil_sub_cat_model.dart';
      export 'guestfil_sub_cat_model.dart';
    
class GuestfilSubCatWidget extends StatefulWidget {
  const GuestfilSubCatWidget({super.key , required this.subcate, }) ;

  final DocumentReference? subcate;

  @override
  State<GuestfilSubCatWidget> createState() => _GuestfilSubCatWidgetState();
}

class _GuestfilSubCatWidgetState extends State<GuestfilSubCatWidget>  {
  late GuestfilSubCatModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuestfilSubCatModel());
...
;
                ...
                final guestfilSubCatSubCategoriaRecord = snapshot.data!;
...
body: SafeArea(
      ...
      children: [Text(
       ...
       guestfilSubCatSubCategoriaRecord.nombreSubc  ,
...
SingleChildScrollView(
      ...
      stream: queryPymeRecord(queryBuilder: (pymeRecord) => pymeRecord.where('subcatPyme', isEqualTo: guestfilSubCatSubCategoriaRecord.nombreSubc, ),),
      builder: (context, snapshot) {
        // Customize what your widget looks like when it's loading.
        if (!snapshot.hasData) {

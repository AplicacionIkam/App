...
import 'package:provider/provider.dart';
      import 'guest_munic_model.dart';
      export 'guest_munic_model.dart';
    
class GuestMunicWidget extends StatefulWidget {
  const GuestMunicWidget({super.key , required this.estado, }) ;

  final DocumentReference? estado;

  @override
  State<GuestMunicWidget> createState() => _GuestMunicWidgetState();
}

class _GuestMunicWidgetState extends State<GuestMunicWidget>  {
  late GuestMunicModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuestMunicModel());
...
;
                ...
                final guestMunicEstadoRecord = snapshot.data!;
...
SingleChildScrollView(
      ...
      stream: queryMunicipioRecord(queryBuilder: (municipioRecord) => municipioRecord.where('refEstado', isEqualTo: guestMunicEstadoRecord.reference, ).orderBy('nombreMun'),),
      builder: (context, snapshot) {
        // Customize what your widget looks like when it's loading.
        if (!snapshot.hasData) {

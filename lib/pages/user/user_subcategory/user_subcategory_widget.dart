...
import 'package:provider/provider.dart';
      import 'user_subcategory_model.dart';
      export 'user_subcategory_model.dart';
    
class UserSubcategoryWidget extends StatefulWidget {
  const UserSubcategoryWidget({super.key , required this.categoria, }) ;

  final DocumentReference? categoria;

  @override
  State<UserSubcategoryWidget> createState() => _UserSubcategoryWidgetState();
}

class _UserSubcategoryWidgetState extends State<UserSubcategoryWidget>  {
  late UserSubcategoryModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserSubcategoryModel());
...
;
                ...
                final userSubcategoryCategoriaRecord = snapshot.data!;
...
SingleChildScrollView(
      ...
      stream: querySubCategoriaRecord(queryBuilder: (subCategoriaRecord) => subCategoriaRecord.where('refCategoria', isEqualTo: userSubcategoryCategoriaRecord.reference, ).orderBy('nombreSubc'),),
      builder: (context, snapshot) {
        // Customize what your widget looks like when it's loading.
        if (!snapshot.hasData) {

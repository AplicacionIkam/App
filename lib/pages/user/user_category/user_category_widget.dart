...
import 'package:provider/provider.dart';
      ...
      export 'user_category_model.dart';
    
class UserCategoryWidget extends StatefulWidget {
  const UserCategoryWidget({super.key }) ;

  

  @override
  State<UserCategoryWidget> createState() => _UserCategoryWidgetState();
}

class _UserCategoryWidgetState extends State<UserCategoryWidget>  {
  late UserCategoryModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserCategoryModel());

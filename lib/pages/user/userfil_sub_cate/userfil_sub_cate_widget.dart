...
import 'package:provider/provider.dart';
      import 'userfil_sub_cate_model.dart';
      export 'userfil_sub_cate_model.dart';
    
class UserfilSubCateWidget extends StatefulWidget {
  const UserfilSubCateWidget({super.key , required this.subcate, }) ;

  final DocumentReference? subcate;

  @override
  State<UserfilSubCateWidget> createState() => _UserfilSubCateWidgetState();
}

class _UserfilSubCateWidgetState extends State<UserfilSubCateWidget>  {
  late UserfilSubCateModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserfilSubCateModel());
...
;
                ...
                final userfilSubCateSubCategoriaRecord = snapshot.data!;
...
body: SafeArea(
      ...
      children: [Text(
       ...
       userfilSubCateSubCategoriaRecord.nombreSubc  ,
...
SingleChildScrollView(
      ...
      stream: queryPymeRecord(queryBuilder: (pymeRecord) => pymeRecord.where('subcatPyme', isEqualTo: userfilSubCateSubCategoriaRecord.nombreSubc, ),),
      builder: (context, snapshot) {
        // Customize what your widget looks like when it's loading.
        if (!snapshot.hasData) {

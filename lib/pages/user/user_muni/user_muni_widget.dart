...
import 'package:provider/provider.dart';
      import 'user_muni_model.dart';
      export 'user_muni_model.dart';
    
class UserMuniWidget extends StatefulWidget {
  const UserMuniWidget({super.key , required this.estado, }) ;

  final DocumentReference? estado;

  @override
  State<UserMuniWidget> createState() => _UserMuniWidgetState();
}

class _UserMuniWidgetState extends State<UserMuniWidget>  {
  late UserMuniModel _model;
...
final scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserMuniModel());
...
;
                ...
                final userMuniEstadoRecord = snapshot.data!;
...
SingleChildScrollView(
      ...
      stream: queryMunicipioRecord(queryBuilder: (municipioRecord) => municipioRecord.where('refEstado', isEqualTo: userMuniEstadoRecord.reference, ).orderBy('nombreMun'),),
      builder: (context, snapshot) {
        // Customize what your widget looks like when it's loading.
        if (!snapshot.hasData) {

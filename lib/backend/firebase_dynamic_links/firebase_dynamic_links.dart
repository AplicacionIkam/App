...
const _kDynamicLinksUrl = 'https://Ikam';
const _kAppBundleId = 'com.mycompany.ikam';
...
Future<String> generateCurrentPageLink(
  ...
  final dynamicLinkParams = DynamicLinkParameters(
    link: Uri.parse('$_kDynamicLinksUrl${GoRouterState.of(context).uri.toString()}'),
  ...
  return isShortLink ? FirebaseDynamicLinks.instance
